...
import dk.mrspring.kitchen.block.BlockJamJar;
...
public class KitchenBlocks
{
	...
	public static final Block wild_tomato = new BlockWildPlantBase("tomato", KitchenItems.tomato, 3);
	public static final Block wild_lettuce = new BlockWildPlantBase("lettuce", KitchenItems.lettuce, 3);
	...
	public static final Block jam_jar = new BlockJamJar("jam_jar");
}
