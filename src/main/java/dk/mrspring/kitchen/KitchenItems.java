...
public class KitchenItems
{
	...
	public static final ItemSandwichable raw_bacon = new ItemSandwichable("raw_bacon", true, 1).setCustomModel(new ModelBaconRaw(), new ModelBaconRaw(), 1, 1);
	...
	public static final ItemSandwichable bacon = new ItemSandwichable("bacon", true, 4).setCustomModel(new ModelBaconCooked(), new ModelBaconCooked(), 2, 2);
	...
	public static final ItemSandwichable raw_chicken_fillet = new ItemSandwichable("raw_chicken_fillet", true, 1);
	public static final ItemSandwichable chicken_fillet = new ItemSandwichable("chicken_fillet", true, 4);
