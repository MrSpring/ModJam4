...
public class ModelJar extends ModelBase
{
	...
	public ModelJar()
	{
		...
		jam.addBox(0F, 0F, 0F, 6, 3, 6);
		jam.setRotationPoint(-3F, 20F, -3F);
		jam.setTextureSize(64, 32);
		jam.mirror = true;
		setRotation(jam, 0F, 0F, 0F);
	}

	public void render(Entity entity, float f, float f1, float f2, float f3, float f4, float f5, float jamR, float jamG, float jamB)
	{
